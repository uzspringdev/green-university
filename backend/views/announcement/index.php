...
?>
<div class="announcement-index mt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage important university updates and announcements</p>
        </div>
        <?= Html::a('<i class="bi bi-plus-lg me-1"></i> Create Announcement', ['create'], ['class' => 'btn btn-primary rounded-pill px-4 shadow-sm']) ?>
    </div>
                    ...
                    [
                        ...
                        'value' => function ($model) {
                                        ...
                                        return Html::tag('div', Html::encode($title), ['class' => 'fw-bold text-dark']) .
                                            Html::tag('div', Html::encode($model->slug), ['class' => 'small text-muted font-monospace mt-1']);
                                    }
                    ],
                    [
