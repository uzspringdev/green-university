...
/** @var common\models\Announcement[] $otherAnnouncements */
/** @var common\models\AnnouncementTranslation $translation */

$this->title = $translation ? $translation->title : Yii::t('app', 'Announcement');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Announcements'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="announcement-view container py-5">
    <div class="row g-5">
        <div class="col-lg-8">
            <article class="announcement-post">
                <header class="mb-5">
                    <span class="news-card-category mb-3">
                ...
                <div class="announcement-content fs-5 lh-lg text-dark">
                    <?= $translation ? $translation->content : '' ?>
                </div>

                <div class="mt-5 pt-5 border-top">
                    <h4 class="fw-bold mb-4 text-primary">
                        <?= Yii::t('app', 'Share this update') ?>
                    </h4>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-5">
                    <div class="card-body p-4">
                        <h5 class="fw-bold text-primary mb-4">
                            <?= Yii::t('app', 'Other Announcements') ?>
                        </h5>
                        <?php if (!empty($otherAnnouncements)): ?>
                            <?php foreach ($otherAnnouncements as $recent): ?>
                                ...
                                <div class="mb-4 pb-4 border-bottom last-child-border-0">
                                    ...
                                    <span class="small text-muted"><i class="bi bi-calendar3 me-1"></i>
                                        <?= Yii::$app->formatter->asDate($recent->published_at) ?>
                                    </span>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <?= Html::a(Yii::t('app', 'See all announcements') . ' <i class="bi bi-arrow-right"></i>', ['index'], ['class' => 'btn btn-light w-100 rounded-pill fw-bold text-primary']) ?>
                    </div>
                </div>
